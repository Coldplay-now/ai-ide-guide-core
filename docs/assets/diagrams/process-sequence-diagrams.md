...
sequenceDiagram
    ...
    IDE-->>U: 更新编辑器内容
%% Standard styling
classDef default fill:#f3e5f5,stroke:#333,stroke-width:2px
classDef highlight fill:#e1bee7,stroke:#333,stroke-width:3px
classDef process fill:#ce93d8,stroke:#333,stroke-width:2px
classDef decision fill:#ba68c8,stroke:#333,stroke-width:2px
```
